...
public:
    // Default GameBoard constructor called: 成员对象gb的初始化会调用GameBoard的构造函数
    Game(){ cout << "Game()\n"; }
...
public:
    ...
    Chess(const Chess& cc) : Game(cc){
        cout << "Chess(const Chess& cc)\n";
    }
